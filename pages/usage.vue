  ...
  <div class="md:mt-10 max-w-screen-md mx-8 md:mx-auto md:px-10 lg:px-0">
    <section>
      ...
      <p class="text-xs font-bold">
        スマホでは画面を横にしていただくと、マップの表示がより見やすくなります。
      </p>
      <div class="imgBox1">
        <img
          class="w-1/2"
    ...
    <section class="mt-14">
      <h2 class="text-2xl">オプション機能</h2>
      <p>マップ右上のメニューバーから、以下の機能をご利用いただけます。</p>
      <ol class="mt-5 mb-5">
        <li>フルスクリーン表示</li>
        <li>マップの印刷</li>
        <li>各種画像形式でダウンロード</li>
    ...
    <section class="mt-14">
      <h2 class="text-2xl">シェアをお願いします</h2>
      <p>
        当アプリを楽しんでいただけたら、下記SNSリンクボタンよりシェアをお願いしますm(_
        _)m
      </p>
    </section>
  </div>
